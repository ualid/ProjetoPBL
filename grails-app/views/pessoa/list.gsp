            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic resize">
				<thead>
					<tr>
                        ...
                        <td>${message(code: 'pessoa.cpf.label', default: 'Cpf')}</td>
					
                        <td>${message(code: 'pessoa.senha.label', default: 'Senha')}</td>
					
                        <td>${message(code: 'pessoa.perfilId.label', default: 'Perfil Id')}</td>
				...
				<g:each in="${pessoaInstanceList}" status="i" var="pessoaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pessoaInstance, field: "perfilId")}</td>
