...
<html>
    ...
    <div class="content" id="container">
            <div class="title"><h5>Cadastrar \${message(code: '${domainClass.propertyName}.label', default: '${className}')}</h5></div>
        <div class="breadCrumbHolder module">
			...
			<g:form action="save" <%= multiPart ? ' enctype="multipart/form-data"' : '' %> class="mainForm">
