...
<div class="wrapper">
    <div class="content" id="container">
        <div class="title"><h5>Editar \${message(code: '${domainClass.propertyName}.label', default: '${className}')}</h5></div>
        ...
        <g:form action="update" <%= multiPart ? ' enctype="multipart/form-data"' : '' %> class="mainForm">
